...
from src.library.modules.cdest.utils.center_point_select import sample_center_points
from src.library.modules.cdest.utils.misc import norm_along_axis_1
from src.library.modules.cdest.utils.executor import execute_batch_pdf
from src.library.modules.cdest.density_estimator.BaseDensityEstimator import BaseDensityEstimator
...
class LSConditionalDensityEstimation(BaseDensityEstimator):
    ...
    def __init__(self, ndim_x=None, ndim_y=None, center_sampling_method='k_means',
                 bandwidth=0.1, n_centers=500, regularization=1.0,
    ...
    def pdf(self, X, Y):
        ...
        if n_samples >= MULTIPROC_THRESHOLD:
            return execute_batch_pdf(self._pdf, X, Y)
        else:
